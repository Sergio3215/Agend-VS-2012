...
namespace frmTest
{
    public partial class frmFinanciasGanacia: Form
    {
        public frmFinanciasGanacia()
        {
            InitializeComponent();
        ...
        private void Export()
        {
            ...
            SaveFileDialog save = new SaveFileDialog();
            save.AddExtension.Equals(".sav1");
            save.FileName = "01_SaveFinancias_ganancia" +  date.ToString("yyyy-MM--dd");
            StreamWriter stw = new StreamWriter(save.FileName);
                    stw.WriteLine("||=============================================================================================================||");
        ...
        {
            frmFinanciasGastos fm = new frmFinanciasGastos();
            fm.Visible = true;
            this.Visible = false;
        }
