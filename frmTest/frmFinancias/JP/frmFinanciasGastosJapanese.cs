...
namespace frmTest
{
    public partial class frmFinanciasGastosJapanese : Form
    {
        public frmFinanciasGastosJapanese()
        {
            InitializeComponent();
        ...
        private void Loaded()
        {
            ...
            if (System.IO.File.Exists("01_SaveFinancias_Gasto") && System.IO.File.Exists("02_SaveFinancias_Gasto"))
            {
                OpenFileDialog load = new OpenFileDialog();
                OpenFileDialog load1 = new OpenFileDialog();

                load.AddExtension.Equals(".sav1");
                load.FileName = "01_SaveFinancias_Gasto";

                load1.AddExtension.Equals(".sav1");
                load1.FileName = "02_SaveFinancias_Gasto";
        ...
        private void Create_Save()
        {
            ...
            save.FileName = "01_SaveFinancias_Gasto";

            save1.AddExtension.Equals(".sav1");
            save1.Filter.Equals(".sav1");
            save1.FileName = "02_SaveFinancias_Gasto";
        ...
        private void Reset()
        {
            ...
            save2.FileName = "File1"; // subtotal gasto
        ...
        private void Export()
        {
            ...
            StreamWriter stw = new StreamWriter(save.FileName);
                    stw.WriteLine("||=============================================================================================================||");
                    stw.WriteLine("||===============================================Resumen de Gastos================================================||");
                    stw.WriteLine("||                                                                                                             \t\t\t\t\t\t\t\t\t||");
                    stw.WriteLine("||                                                                                                             \t\t\t\t\t\t\t\t\t||");
                    stw.WriteLine("||=============================================================================================================||");
        ...
        private void frmFinanciasGastos_FormClosing(object sender, FormClosingEventArgs e)
        {
            Close();
        }
        ...
        private void agendaDeGananciasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmFinanciasGanaciaJapanese fm = new frmFinanciasGanaciaJapanese();
            fm.Visible = true;
            this.Visible = false;
        }
        ...
        {
            frmJapanese fm = new frmJapanese();
            fm.Visible = true;
            this.Visible = false;
        }
